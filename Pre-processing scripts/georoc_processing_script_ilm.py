...
data = pd.read_excel(r"/home/avi/Documents/Research/Mineral identifier ann IISER Mohali/new random comp generator/GEOROC data/2022-12-SGFTFN_ILMENITES_unprocessed.xlsx",header=0,index_col=0)
...
data_cleaned = data2.loc[~data2['TIO2(WT%)'].isna(),:]
...
data_px.pop("FEO(WT%)")
data_px.columns = ["SiO2", "TiO2", "Al2O3", "Cr2O3", "FeO", "MnO", "MgO", "CaO", "Na2O", "K2O",'Mineral']
...
data_px2.to_excel(r"/home/avi/Documents/Research/Mineral identifier ann IISER Mohali/new random comp generator/GEOROC data/processed minerals/molar tables/new data/ilm_processed_mol.xlsx")
